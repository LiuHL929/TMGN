...
from TMGN.gadgets.metrics import Accuracy, VQAScore, Scalar
...
def set_task(pl_module):
    ...
    #print(pl_module.current_tasks)
    #print(pl_module.hparams.config["loss_names"].items())
    return
